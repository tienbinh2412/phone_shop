    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Sản phẩm<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="user/no_login/iPhone.php">iPhone</a></li>
          <li><a href="user/no_login/oppo.php">Oppo</a></li>
          <li><a href="user/no_login/samsung.php">Samsung</a></li>
        </ul>
      </li>
      <li><a href="user/no_login/tracking.php">Tracking</a></li>
      <li><a href="user/no_login/contact.php">Contact</a></li>
    </ul>
