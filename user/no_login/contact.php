...
@media screen and (min-width: 1200px){
    ...
    <section class = "contact-section">
      <div class = "contact-bg">
        ...
        <p class = "text">Khách hàng có mọi yếu cầu hay thắc mắc về sản phẩm có thể liên hệ với shop của chúng tôi để được nhân viên hỗ trợ một cách chi tiết nhất.</p>
      </div>
